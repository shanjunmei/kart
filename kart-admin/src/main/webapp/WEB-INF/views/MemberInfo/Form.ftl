...
<body>
	...
	<form action="${BasePath !}/MemberInfo/save.do" method="post" id="myform" class="ff-form">
	...
	<script type="text/javascript" src="${BasePath !}/asset/js/kart/memberInfo/memberInfo_form.js?v=${ver !}"></script>
